...
var _vueCommon = __webpack_require__(3);
...
var page = {
    title: "前端框架study",
    topics: [{ title: "VUE", des: "" }, { title: "ANGULAR", des: "" }, { title: "REACT", des: "" }, { title: "WEBPACK", des: "" }, { title: "Virtual DOM", des: "" }, { title: "ANGULAR MATERIAL", des: "" }, { title: "设计模式", des: "" }, { title: "算法", des: "" }, { title: "JQUERY", des: "" }, { title: "KISSY", des: "" }, { title: "JS", des: "" }, { title: "CSS", des: "" }],
    selected: 0
};
var subtitles = ["demo", "运行过程", "源码分析", "使用、技巧总结", "比较其它框架"];
page.topics.forEach(function (t, i) {
    t.subs = [];
...
new _vueCommon2.default({
    ...
    methods: {
        ...
        getclass: function getclass(length) {
